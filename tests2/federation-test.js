...
var lang       = require("lively.lang"),
    server     = require("../lib2/messengers/nodejs-tracker"),
    client     = require("../lib2/messengers/nodejs-client"),
    messaging  = require("../lib2/messaging"),
    sessions   = require("../lib2/sessions");
...
describe("federation", function() {
  ...
  beforeEach(function(done) {
    ...
    lang.fun.waitForAll([
      ...
      n => tracker1.federationConnect({port: port2}, n),
  ...
  afterEach(function(done) {
    ...
    lang.fun.composeAsync(
      n      => clients ? lang.fun.waitForAll(clients.map(c => n => c.close(n)), n) : n(null,null),
      (_, n) => trackers ? lang.fun.waitForAll(trackers.map(t => n => t.close(n)), n) : n(null,null)
    )(done);
  });
